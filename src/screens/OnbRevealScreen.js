...
import { Animated, SafeAreaView, ScrollView, StyleSheet, Text, View, Pressable } from 'react-native';
...
function SkeletonBox({ width, height, radius = 12, style }) {
  ...
  useEffect(() => {
    const loop = Animated.loop(
      Animated.sequence([
        Animated.timing(shimmer, { toValue: 0.7, duration: 850, useNativeDriver: true }),
  ...
  return (
    <Animated.View
      style={[
        { width, height, borderRadius: radius, backgroundColor: 'rgba(255,255,255,0.14)', opacity: shimmer },
        style,
      ]}
    />
  );
  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.paletteSection}>
        <SkeletonBox width={130} height={10} radius={5} style={{ marginBottom: 14 }} />
        ...
        {loading ? (
          ...
          <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
            ...
            <Animated.View style={[styles.leadIn, slide(anim1)]}>
              ...
              <Text style={styles.leadSub}>we've mapped your reading identity</Text>
            </Animated.View>
            ...
            <Animated.View style={[styles.identityCard, slide(anim1, 24)]}>
              ...
              <Text style={[styles.identityTypeAccent, { fontSize: accentSize, lineHeight: accentLineHeight }]}>
                {archetypeRest}
              </Text>
                ...
                <View style={styles.paletteChips}>
                  {genres.map((g, i) => {
                    ...
                    return (
                      ...
                      >
                        <Text style={[styles.paletteChipText, dark && styles.paletteChipTextDark]}>{g}</Text>
                      </View>
                    );
                  })}
                </View>
...
const styles = StyleSheet.create({
  ...
  identityTypeAccent: { fontWeight: '400', fontStyle: 'italic', color: colors.lime, letterSpacing: -1.5, marginTop: -10 },
  ...
  affinityCard: { flex: 1, borderRadius: radii.xl, padding: 16, backgroundColor: colors.lime },
  ...
  pairDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: colors.lime, opacity: 0.7 },
